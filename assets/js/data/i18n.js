export const I18N = {
  "pt-BR": {
    ...
    cameraCardSubtitle: "Posicione a mão no centro e mantenha o sinal estável por {seconds}s.",
    ...
    inst3: "Mantenha o sinal por ~{seconds}s para auto-adicionar.",
    inst4: "Use os botões para editar o texto reconhecido.",
    footerText: "Lexis AI roda inteiramente no navegador. Nenhum vídeo é enviado a servidores.",
  ...
  en: {
    ...
    pageDescription: "Lexis AI: real-time sign language recognition running entirely in the browser.",
    ...
    footerText: "Lexis AI runs entirely in your browser. No video is sent to any server.",
  ...
  ja: {
    ...
    footerText: "Lexis AI はブラウザ内で動作します。動画はサーバーに送信されません。",
    statusReady: "開始準備完了",
  ...
  "pt-PT": {
    ...
    footerText: "Lexis AI corre inteiramente no navegador. Nenhum vídeo é enviado para servidores.",
    statusReady: "Pronto para iniciar",
