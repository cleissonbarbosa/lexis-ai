...
export const SIGN_GESTURES = {
  libras: {
    ...
    alphabet: {
      ...
      B: { emoji: "🖐️", icon: LIBRAS_SVG("b"), desc: "Mão aberta, dedos juntos, polegar sobre a palma" },
      ...
      D: { emoji: "☝️", icon: LIBRAS_SVG("d"), desc: "Indicador estendido, demais dedos e polegar formam círculo" },
      E: { emoji: "✊", icon: LIBRAS_SVG("e"), desc: "Dedos curvados, polegar tucado por baixo" },
      F: { emoji: "👌", icon: LIBRAS_SVG("f"), desc: "Indicador e polegar em círculo, demais dedos estendidos" },
      G: { emoji: "👉", icon: LIBRAS_SVG("g"), desc: "Indicador e polegar apontando para o lado" },
      H: { emoji: "👉", icon: LIBRAS_SVG("h"), desc: "Indicador e médio estendidos apontando para o lado" },
      I: { emoji: "🤙", icon: LIBRAS_SVG("i"), desc: "Punho com mindinho estendido" },
      J: { emoji: "🤙", icon: LIBRAS_SVG("j"), desc: "Como I, traçando um J no ar" },
      K: { emoji: "✌️", icon: LIBRAS_SVG("k"), desc: "Indicador e médio abertos, polegar entre eles" },
      ...
      P: { emoji: "👇", icon: LIBRAS_SVG("p"), desc: "Como K apontando para baixo" },
      ...
      T: { emoji: "✊", icon: LIBRAS_SVG("t"), desc: "Polegar entre indicador e médio" },
      U: { emoji: "✌️", icon: LIBRAS_SVG("u"), desc: "Indicador e médio estendidos juntos" },
      V: { emoji: "✌️", icon: LIBRAS_SVG("v"), desc: "Indicador e médio estendidos e separados" },
      W: { emoji: "🤟", icon: LIBRAS_SVG("w"), desc: "Indicador, médio e anelar estendidos e separados" },
      X: { emoji: "☝️", icon: LIBRAS_SVG("x"), desc: "Indicador curvado em gancho" },
      Y: { emoji: "🤙", icon: LIBRAS_SVG("y"), desc: "Polegar e mindinho estendidos" },
      Z: { emoji: "☝️", icon: LIBRAS_SVG("z"), desc: "Indicador traça um Z no ar" }
    }
  },
  asl: {
    label: "ASL",
